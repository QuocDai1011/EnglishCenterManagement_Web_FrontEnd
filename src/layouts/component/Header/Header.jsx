...
function Header() {
    ...
    const quickAddItems = [
        ...
        // {
        //     header: (
        //         <div className={cx('box-search')} style={{ padding: '12px 16px' }}>
        //             <input
        //                 type="text"
        //                 placeholder="Search..."
        //                 onClick={(e) => e.stopPropagation()}
        //             />
        //             <FaSearch className={cx('icon-search')} size={24} style={{ color: '#828282' }} />
        //         </div>
        //     )
        // },
        {
    ...
    const iconGridItems = [
        {
            header: (
                <div className={cx('wrap-menu')} style={{
                    display: 'flex',
                    alignItems: 'center',
        ...
        {
            header: (
                <div className={cx('wrap-input')} style={{
                    padding: '0px 16px',
                    display: 'flex',
        ...
        },
        {
            header: (
                <div style={{ textAlign: 'center', padding: '8px 0' }}>
                    ...
                    <div style={{ color: '#666' }}>
                        <a style={{ fontSize: '10px', textDecoration: 'underline', marginRight: '10px', fontWeight: 400 }} href="/product-policy">Chính sách sản phẩm</a>

                        <a style={{ fontSize: '10px', textDecoration: 'underline', fontWeight: 400 }} href="/terms">Điều khoản dịch vụ</a>
                    </div>
                    <div style={{ fontSize: '11px', marginTop: '4px' }}>
                        Copyright by EMSO Việt Nam, JSC.
                    </div>
                </div>
            )
        },
                    ...
                    <div className={cx('header-right')}>
                        ...
                        <div style={{ position: 'relative', display: 'inline-block' }}>
                                    ...
                                    <div className={cx('scroll-bar')}>
                                        {quickAddItems.map((item, index) => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    {item.icon && <div className={cx('icon')} style={{ flexShrink: 0 }}>{item.icon}</div>}
                                                    <div style={{ flex: 1 }}>
                                                        {item.title && <div style={{ fontWeight: 600, fontSize: '15px' }}>{item.title}</div>}
                                                    </div>
                                                </button>
                                            );
                                        })}
                            ...
                            <Dropdown
                                button={
                                    <button className={cx('action-btn')}>
                                        <span><BsFillGrid3X3GapFill size={26} /></span>
                                    </button>
                                }
                                items={iconGridItems}
                                width="xlarge"
