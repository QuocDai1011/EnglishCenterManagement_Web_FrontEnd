      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          <p className="text-xl font-semibold text-gray-500 uppercase tracking-wide mb-1">
            ...
            {value ? <input type='text' value={text} onChange={e => setText(e.target.value)} className="text-xl text-gray-800 p-2"/> : <span className="italic text-gray-400">Chưa cập nhật</span>}
